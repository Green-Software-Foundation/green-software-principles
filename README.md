...
## Scope
The original Principles of Green Software located at https://principles.green was created in 2019. As the field of Green Software has evolved the need to update the principles has also evolved.

Specifically there is a requirement to extend knowledge in the sections on carbon, electricity, carbon intensity and embodied carbon and add sections on climate commitments as well as update the measurement section to discuss the Software Carbon Intensity (SCI) specification.
